...
Citizen.CreateThread(function()
	while true do
		...
		while IsControlJustPressed(1, 288) and pressed do
			Wait(10)
		end
		if IsControlJustPressed(1, 288) and not pressed then
			pressed = true
			level = level + 1
			if level > 3 then
				level = 1
			...
			Wait(200)
		elseif not IsControlJustPressed(1, 288) and pressed then
			pressed = false
		end
	end
end)
